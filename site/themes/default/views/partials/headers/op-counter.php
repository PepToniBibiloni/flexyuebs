...
<header id="header" class="full-header transparent-header border-full-header dark static-sticky" data-sticky-class="not-dark" data-sticky-offset="full" data-sticky-offset-negative="100">
    ...
    <div id="header-wrap">
        ...
        <div class="container clearfix">
            ...
            ============================================= -->
            <div id="logo">
                <a href="index.html" class="standard-logo" data-dark-logo="/site/images/canvasone-dark.png"><img src="/site/images/canvasone-dark.png" alt="Canvas Logo"></a>
                <a href="index.html" class="retina-logo" data-dark-logo="/site/images/canvasone@2x.png"><img src="/site/images/canvasone@2x.png" alt="Canvas Logo"></a>
            </div><!-- #logo end -->
