...
if (Admin::isAdminArea()) {
    ...
    Event::addListener('onCurrentEntryBeforeLoaded', function () {
        ...
        NavigationManager::addItem('extends', 'partials', '<i class="fas fa-puzzle-piece"></i>' . __('admin_partial', Registry::get('settings.locale')), Http::getBaseUrl() . '/admin/partials', ['class' => 'nav-link']);
